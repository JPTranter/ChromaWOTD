...
- [x] **Button Hardware Interaction & Deep Sleep Wake** (Phase 5, 2026-09-12):
  ...
  - [x] Content mode is time-based: Verse 00:00–16:29, Word 16:30–23:59 (the word window was moved
        from noon to 16:30 on 2026-09-22 so it opens after A.Word.A.Day's 00:01 US Eastern publish
        instant in every month — see `kCcWordOfDayStartMinutes` and LESSONS §70).
